...
def check_if_can_teleport(field, random_tp):
    ...
    for i in soldier_position:
        ...
        if (
            field[i[0]][i[1]] == consts.MINE
            or field[i[0]][i[1] + 1] == consts.MINE
            or field[i[0] + 1][i[1]] == consts.MINE
            or field[i[0] + 1][i[1] + 1] == consts.MINE
            or field[i[0] + 2][i[1]] == consts.MINE
            or field[i[0] + 2][i[1] + 1] == consts.MINE
            or field[i[0] + 3][i[1]] == consts.MINE
            or field[i[0] + 3][i[1] + 1]
        ):
            return True
        else:
            return False
